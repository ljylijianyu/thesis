...
if __name__ == '__main__':
    dataset = Path('/home/ljy/colmap_model/gaoguangpuxiangji/ggpxj-model/images/')
    outputs = Path('/home/ljy/outputs/ggpxj/')
    gt_dirs = Path('/home/ljy/colmap_model/gaoguangpuxiangji/gtdir/')
    num_loc = 10
    num_covis = 10
